    ...
    <section id="experiences" className="pt-20 bg-black overflow-hidden relative">
      ...
      >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-4 text-white/85 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
      ...
      <div className="absolute bottom-0 left-0 w-full h-[2px] z-30">
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[60%] h-[40px] bg-[#FF6600]/15 blur-[25px] rounded-full pointer-events-none" />
      </div>
    </section>
  );
}
