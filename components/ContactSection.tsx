            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {contactItems.map((item) => (
                <div key={item.label} className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-[#3B3BE8] shrink-0">
                    {item.icon}
                  </div>
                  <div>
                    ...
                    {item.href ? (
                      <a
                        ...
                        className="text-white font-semibold text-base hover:text-[#3B3BE8] transition-colors"
                      >
                        {item.value}
                      </a>
                    ) : (
