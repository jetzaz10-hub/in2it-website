        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1.5fr_1.5fr] gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              {/* Share icon */}
              <a href="https://in2it.co.th" target="_blank" rel="noopener noreferrer" aria-label="Visit IN2IT website" className="w-9 h-9 rounded-full bg-white/5 border-white/5 flex items-center justify-center text-white/50 hover:text-white hover:bg-[#4A32FF] transition-all">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                </svg>
              </a>
              {/* Linkedin icon */}
              <a href="https://th.linkedin.com/company/in2it-company" target="_blank" rel="noopener noreferrer" aria-label="IN2IT on LinkedIn" className="w-9 h-9 rounded-full bg-white/5 border-white/5 flex items-center justify-center text-white/50 hover:text-white hover:bg-[#4A32FF] transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              {/* Facebook icon */}
              <a href="https://www.facebook.com/in2itservice/" target="_blank" rel="noopener noreferrer" aria-label="IN2IT on Facebook" className="w-9 h-9 rounded-full bg-white/5 border-white/5 flex items-center justify-center text-white/50 hover:text-white hover:bg-[#4A32FF] transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
